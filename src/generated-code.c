...
static const GDBusArgInfo * const _agent_manager1_method_info_register_agent_IN_ARG_pointers[] =
{
  &_agent_manager1_method_info_register_agent_IN_ARG_agent.parent_struct,
  &_agent_manager1_method_info_register_agent_IN_ARG_capability.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _agent_manager1_method_info_unregister_agent_IN_ARG_pointers[] =
{
  &_agent_manager1_method_info_unregister_agent_IN_ARG_agent.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _agent_manager1_method_info_request_default_agent_IN_ARG_pointers[] =
{
  &_agent_manager1_method_info_request_default_agent_IN_ARG_agent.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _agent_manager1_method_info_pointers[] =
{
  &_agent_manager1_method_info_register_agent.parent_struct,
  &_agent_manager1_method_info_unregister_agent.parent_struct,
  &_agent_manager1_method_info_request_default_agent.parent_struct,
  NULL
};
 ...
 */
guint
agent_manager1_override_properties (GObjectClass *klass G_GNUC_UNUSED, guint property_id_begin)
{
  return property_id_begin - 1;
}
...
void
agent_manager1_complete_register_agent (
    AgentManager1 *object G_GNUC_UNUSED,
    GDBusMethodInvocation *invocation)
{
  g_dbus_method_invocation_return_value (invocation,
    g_variant_new ("()"));
...
static void
agent_manager1_proxy_get_property (GObject      *object G_GNUC_UNUSED,
...
static void
agent_manager1_proxy_set_property (GObject      *object G_GNUC_UNUSED,
  guint         prop_id G_GNUC_UNUSED,
...
static void
agent_manager1_proxy_iface_init (AgentManager1Iface *iface G_GNUC_UNUSED)
{
}
...
static void
agent_manager1_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton G_GNUC_UNUSED)
{
}
...
static void
agent_manager1_skeleton_iface_init (AgentManager1Iface *iface G_GNUC_UNUSED)
{
}
...
void
gatt_descriptor1_complete_read_value (
    GattDescriptor1 *object G_GNUC_UNUSED,
    GDBusMethodInvocation *invocation,
    const gchar *value)
{
  g_dbus_method_invocation_return_value (invocation,
...
object_default_init (ObjectIface *iface)
{
  ...
  /**
   * Object:agent-manager1:
   *
   * The #AgentManager1 instance corresponding to the D-Bus interface <link linkend="gdbus-interface-org-bluez-AgentManager1.top_of_page">org.bluez.AgentManager1</link>, if any.
   *
   * Connect to the #GObject::notify signal to get informed of property changes.
   */
  g_object_interface_install_property (iface, g_param_spec_object ("agent-manager1", "agent-manager1", "agent-manager1", TYPE_AGENT_MANAGER1, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
...
/**
 * object_get_agent_manager1:
 * @object: A #Object.
 *
 * Gets the #AgentManager1 instance for the D-Bus interface <link linkend="gdbus-interface-org-bluez-AgentManager1.top_of_page">org.bluez.AgentManager1</link> on @object, if any.
 *
 * Returns: (transfer full) (nullable): A #AgentManager1 that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 */
AgentManager1 *object_get_agent_manager1 (Object *object)
{
  GDBusInterface *ret;
  ret = g_dbus_object_get_interface (G_DBUS_OBJECT (object), "org.bluez.AgentManager1");
  if (ret == NULL)
    return NULL;
  return AGENT_MANAGER1 (ret);
}
...
/**
 * object_peek_agent_manager1: (skip)
 * @object: A #Object.
 *
 * Like object_get_agent_manager1() but doesn't increase the reference count on the returned object.
 *
 * It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.
 *
 * Returns: (transfer none) (nullable): A #AgentManager1 or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 */
AgentManager1 *object_peek_agent_manager1 (Object *object)
{
  GDBusInterface *ret;
  ret = g_dbus_object_get_interface (G_DBUS_OBJECT (object), "org.bluez.AgentManager1");
  if (ret == NULL)
  ...
  GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case 3:
      interface = g_dbus_object_get_interface (G_DBUS_OBJECT (object), "org.bluez.AgentManager1");
      g_value_take_object (value, interface);
      break;
...
object_proxy_class_init (ObjectProxyClass *klass)
{
  ...
  g_object_class_override_property (gobject_class, 3, "agent-manager1");
  ...
  GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case 3:
      ...
      if (interface != NULL)
        {
          g_warn_if_fail (IS_AGENT_MANAGER1 (interface));
          g_dbus_object_skeleton_add_interface (G_DBUS_OBJECT_SKELETON (object), interface);
        }
      else
        {
          g_dbus_object_skeleton_remove_interface_by_name (G_DBUS_OBJECT_SKELETON (object), "org.bluez.AgentManager1");
        }
      break;
...
/**
 * object_skeleton_set_agent_manager1:
 * @object: A #ObjectSkeleton.
 * @interface_: (nullable): A #AgentManager1 or %NULL to clear the interface.
 *
 * Sets the #AgentManager1 instance for the D-Bus interface <link linkend="gdbus-interface-org-bluez-AgentManager1.top_of_page">org.bluez.AgentManager1</link> on @object.
 */
void object_skeleton_set_agent_manager1 (ObjectSkeleton *object, AgentManager1 *interface_)
{
  g_object_set (G_OBJECT (object), "agent-manager1", interface_, NULL);
}
  ...
  if (g_once_init_enter (&once_init_value))
    {
      ...
      g_hash_table_insert (lookup_hash, (gpointer) "org.bluez.AgentManager1", GSIZE_TO_POINTER (TYPE_AGENT_MANAGER1_PROXY));
