...
void adapter1_complete_set_discovery_filter (
    Adapter1 *object,
    GDBusMethodInvocation *invocation);
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (AgentManager1Proxy, g_object_unref)
#endif
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (AgentManager1Skeleton, g_object_unref)
#endif
